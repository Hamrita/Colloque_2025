...
```{r hyper, echo=FALSE}
  "Hyperparameter"=c("Number of layers", "Number of units", "Learning rate", "Batch size", "Dropout rate", "Sequence length")
  "Range/Values"=c("1 to 4 (integer)","1 to 10 (integer)", "0.0001, to 0.01 (Logarithmic scale)","16 to 1024 ( Powers of 2)", "0.1 to 0.6 (Increments of 0.1)", "1 to 60 (integer)")
  "LSTM"=c("","","","","","")
  "GRU"=c("","","","","","")
  "LSTM-GRU"=c("","","","","","")
